...
A Radix-headless component kit styled entirely from the eight --t-* tokens, three surface depth levels, four motion tiers, and no animation inside the terminal grid.
