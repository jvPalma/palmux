# tab-accents Specification

## Purpose

Theme-aware tab accent colors: stable persisted color names resolving to per-theme values, a twelve-color palette, and a shaped, stateful top-border accent that never collides with split/dirty/reorder indicators.
