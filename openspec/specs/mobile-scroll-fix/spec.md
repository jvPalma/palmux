# mobile-scroll-fix Specification

## Purpose

Mobile swipe-scroll resolves to the surface the user intends under nested mouse-reporting apps (e.g. a TUI in tmux), falling back to local xterm scrollback when nothing consumes wheel input.
